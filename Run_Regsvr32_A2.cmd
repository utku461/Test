...
REM ============================================================
REM Run-Skript fuer Regsvr32 A2
REM
REM Aufgabe:
REM - nimmt eine Run-ID entgegen
REM - erfasst Start- und Endzeitpunkt der Testhandlung
REM - startet die lokale A2-Scriptlet-Datei ueber scrobj.dll
...
REM als alleiniges Erfolgskriterium verwendet.
REM
...
if "%~1"=="" (
    ...
    echo Beispiel: Run_Regsvr32_A2.cmd DEV-REG-A2-P2-01
    exit /b 2
)
...
set "TEST_FILE=C:\Lab\TestFiles\Regsvr32\A2_Regsvr32.sct"
...
REM Bei Regsvr32 entscheidet an dieser Stelle das funktionale
REM Ergebnis. Die Integritaet wird spaeter per SHA-256 geprueft.
if "!DESTINATION_FILE_EXISTS!"=="YES" (
...
echo.
echo ============================================================
echo Regsvr32 A2 abgeschlossen.
echo Run-ID: !RUN_ID!

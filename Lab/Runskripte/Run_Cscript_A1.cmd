...
if "%~1"=="" (
    ...
    echo Beispiel: Run_Cscript_A1.cmd DEV-CS-A1-P2-01
    exit /b 2
)
...
set "TEST_FILE=C:\Lab\TestFiles\Cscript\A1_Cscript.js"
set "RESULT_FILE=C:\Lab\Outputs\A1\A1_Cscript_Result.txt"
...
if exist "%RESULT_FILE%" (
    ...
    findstr /c:"Component=cscript.exe" "%RESULT_FILE%" >nul
...
REM Bei Cscript erwarten wir einen erfolgreichen Prozessabschluss
REM sowie die korrekte Referenzdatei.
